...
实现切段后**三条全部转为 `success`**（2026-09-17 实测，单批耗时 3 小时 23 分）：

| aweme_id | 时长 | 原状态 | 切段结果 | 分段 | 正文 |
|---|---|---|---|---|---|
| `7479792365641813258` | 2.5 h | failed | success | 6/6 | 45,115 字 |
| `7571479934070263074` | 8.8 h | too_large | success | 18/18 | 172,570 字 |
| `7475276578130267430` | 9.7 h | failed | success | 20/20 | 187,211 字 |

三条合计回捞约 **40.5 万字**正文。耗时与时长近似线性（2.5h→20 分、8.8h→203 分、9.7h→72 分，
差异主要来自网络带宽与 ASR 排队）。
